...
if(gu_random === 0){
	console.log("グーとグー");
	$("#state").html('<img src="https://github.com/altosaex/github_kadai01/blob/main/img/gu.jpg?raw=true" height ="80" width="80" />');
	$("#result").html("あいこ");
	$("#result").width();
	$("#jojo_nigeru").get(0).play();
} else if (gu_random === 1){
	console.log("グーとチョキ");
	$("#state").html('<img src="https://github.com/altosaex/github_kadai01/blob/main/img/cho.jpg?raw=true" height ="80" width="80" />');
	$("#result").html("勝ち");
	$("#jojo_arideverychi").get(0).play();
} else if (gu_random === 2){
	console.log("グーとパー");
	$("#state").html('<img src="https://github.com/altosaex/github_kadai01/blob/main/img/pa.jpg?raw=true" height ="80" width="80" />');
	$("#result").html("負けー");
